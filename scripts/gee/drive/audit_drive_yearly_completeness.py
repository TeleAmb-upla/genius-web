...
def _audit_drive(target_year: int) -> int:
    ...
    check_csv_in_folder(paths.DRIVE_AOD_CSV_YEARLY, "AOD_Yearly_Region.csv", "AOD región")
...
def _audit_local(target_year: int) -> int:
    ...
    check_csv(paths.REPO_RASTER_AOD_YEARLY / "AOD_Yearly_Region.csv", "AOD_Yearly_Region")
    check_csv(paths.REPO_RASTER_NO2_YEARLY / "NO2_y_region.csv", "NO2_y_region")
    check_csv(paths.REPO_RASTER_SO2_YEARLY / "SO2_y_region.csv", "SO2_y_region")
    check_csv(paths.REPO_RASTER_LST_YEARLY / "LST_y_urban.csv", "LST_y_urban")
