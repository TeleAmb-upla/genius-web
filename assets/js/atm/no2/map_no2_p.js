...
const [_defaultLeft, _defaultRight] = getDefaultYearPair('no2');
...
export async function map_no2_p() {
    ...
    currentMap = L.map("p28", GENIUS_LEAFLET_MAP_OPTIONS).setView([GENIUS_LAT, GENIUS_LNG], GENIUS_ZOOM_REGIONAL);
    ...
    addCenteredTitle(
        currentMap,
        geniusTitleForProduct("NO₂ — mapa por píxel", "no2"),
        { temporalTitle: true },
    );
