...
def list_missing_no2_yearmonth_months() -> list[tuple[int, int]]:
    return ym_lib.list_missing_yearmonth_months(
        paths.ASSET_NO2_YEARMONTH,
        start_year=2019,
    )
...
def plan_derivative_exports(
    *,
    ...
    # NO2 no tiene access directo a collection desde vectors.py,
    # usar spec + asset path directo
    ic = ee.ImageCollection(paths.ASSET_NO2_YEARMONTH)
