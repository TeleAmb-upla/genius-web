...
export async function map_ndvi_2022(map) {
    // Leer el archivo NDVI 2022
    const response = await fetch('/assets/vec/raster/NDVI_pixel/NDVI_Yearly/NDVI_Yearly_2022.tif');
