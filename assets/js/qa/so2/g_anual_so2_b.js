...
export async function g_a_so2_b() {
    ...
    d3.select("#p41").selectAll("*").remove();

    // Append the svg object to the div with id "p41"
    var svg = d3.select("#p41")
        .append("svg")
