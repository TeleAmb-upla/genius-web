import { createYearSelector, positionYearSelector } from './no2_z_b/utils_z_b_y.js'; 
import { createMonthSelector, positionMonthSelector } from './no2_z_b/utils_z_b_m.js';
import { LayersControl } from '../control.js';
import { updateMapLayerYear, updateMapLayerMonth } from './no2_z_b/layer_z_b.js';
import { createYearLegend, createMonthLegend } from './no2_z_b/legend.js';
import {map_trend, createTrendLegend} from './no2_z_b/trend_b.js'
...
<div id="title" class="map-title">
  ...
  const beforeMap = new maplibregl.Map({
    container: 'before_b_no2', // Contenedor ajustado a 'before_b_no2'
    style: {
        version: 8,
        sources: {
            carto: {
...
const afterMap = new maplibregl.Map({
    container: 'after_b_no2', // Contenedor ajustado a 'after_b_no2'
    style: {
        version: 8,
        sources: {
            carto: {
   ...
   container.appendChild(trendLegend);
     ...
     window.compareInstance = new maplibregl.Compare(beforeMap, afterMap, '#p31', {
       mousemove: false,
