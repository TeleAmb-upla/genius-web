...
export async function map_01(map) {
    // Leer el archivo '/assets/data/raster/NO2/NO2_Monthly/NO2_Monthly_01.tif
    const response = await fetch(resolveAssetUrl('assets/data/raster/NO2/NO2_Monthly/NO2_Monthly_01.tif'));
