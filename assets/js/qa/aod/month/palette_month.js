export function ToColorMonth(AOD_Median) {
            const minlst = 7.88;
        const maxlst = 45.00;
        ...
        if (AOD_Median < minlst) AOD_Median = minlst;
        if (AOD_Median > maxlst) AOD_Median = maxlst;
    
        // Normalización del valor dentro del rango
        let ratio = (AOD_Median - minlst) / (maxlst - minlst);
