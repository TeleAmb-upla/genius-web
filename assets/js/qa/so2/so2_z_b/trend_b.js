...
export async function map_trend(map) {
    const geojsonUrl = '/assets/vec/vectoriales/SO2_Yearly_ZonalStats/SO2_Yearly_ZonalStats_Barrios/Trend_SO2_ZonalStats_Barrios.geojson';
    ...
    map.on('click', 'generic-trend-layer', (e) => {
        ...
        new maplibregl.Popup()
            ...
            .setHTML(`
                ...
                <strong>Tendencia SO²:</strong> ${properties.slope_median.toFixed(3)}<br>
...
export function createTrendLegend() {
    ...
    title.textContent = 'Tendencia SO² Barrios';
    ...
    subtitle.textContent = '2019 - 2023';
