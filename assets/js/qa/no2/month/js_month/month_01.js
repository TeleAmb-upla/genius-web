...
export async function map_01(map) {
    // Leer el archivo '/assets/vec/raster/no2_pixel/NO2_Monthly/NO2_Monthly_01.tif
    const response = await fetch('/assets/vec/raster/no2_pixel/NO2_Monthly/NO2_Monthly_01.tif');
