"""
Obsoleto frente a ``scripts/repo/rasters/quantize_rasters_web.py`` (COG + escalas alineadas
con el front en ``assets/js/raster_quantized_decode.js``).
...
Usage:
    python scripts/repo/rasters/optimize_rasters.py [--dry-run]
