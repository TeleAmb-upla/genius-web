...
export async function map_trend(map) {
    const geojsonUrl = '/assets/vec/vectoriales/NDVI_Yearly_ZonalStats_Manzanas/Trend_NDVI_ZonalStats_Manzanas.geojson';
...
export function createTrendLegend() {
    ...
    title.textContent = 'Tendencia NDVI Manzanas';
