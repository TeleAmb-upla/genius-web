...
export function addCenteredTitle_noche(map) {
    ...
    mapTitleDiv.innerHTML = `Iluminacion Clasificada Plaza Vieja`;
}
...
export function addCenteredTitle_rgb(map) {
    ...
    // Actualiza el contenido del título
    mapTitleDiv.innerHTML = `Color Verdadero Plaza Vieja`;
}
...
export function addCenteredTitle_temp(map) {
    ...
    // Actualiza el contenido del título
    mapTitleDiv.innerHTML = `Temperatura Plaza Vieja`;
}
