...
function valueToSTColor(value) {
    const spec = trendLegendSpec('no2', 'zonalManzana');
...
export function createTrendLegend() {
    ...
    title.innerHTML = `Tendencia NO<sub>2</sub> Manzanas${geniusYearSpanSuffix('no2')}`;
    fillZonalTrendLegendPanel(legendContent, title, 'no2', 'zonalManzana', {
        steps: 7,
        decimals: 2,
    });
