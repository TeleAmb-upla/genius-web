...
const  so2MonthlyFiles_tif = Array.from({ length: 12 }, (_, i) => {
    ...
    return {
        url: `/assets/data/raster/SO2/SO2_Monthly/SO2_Monthly_${month}.tif`,
...
const so2YearlyFiles_tif = Array.from({ length: endYear - startYear + 1 }, (_, i) => {
    ...
    return {
        url: `/assets/data/raster/SO2/SO2_Yearly/SO2_Yearly_${year}.tif`,
        name: `SO2_Yearly_${year}.tif`
    };
});

const so2TrendFiles_tif = [
    { url: '/assets/data/raster/SO2/SO2_Trend/SO2_Yearly_Trend.tif', name: 'SO2_Trend.tif' },
    { url: '/assets/data/csv/SO2_Mensual_Comunal.csv', name: 'SO2_Monthly.csv' },
    { url: '/assets/data/csv/SO2_Anual_Comunal.csv', name: 'SO2_Anual.csv' }
 ];
...
const so2MonthlyFiles_json_Barrio = Array.from({ length: 12 }, (_, i) => {
    const month = String(i + 1).padStart(2, '0');
    return {
        url: `/assets/data/geojson/SO2/SO2_Monthly_ZonalStats/SO2_Monthly_ZonalStats_Barrios/SO2_Monthly_ZonalStats_Barrios_${month}.geojson`,
...
const so2YearlyFiles_json_Barrio = Array.from({ length: endYear - startYear + 1 }, (_, i) => {
    const year = startYear + i;
    return {
        url: `/assets/data/geojson/SO2/SO2_Yearly_ZonalStats/SO2_Yearly_ZonalStats_Barrios/SO2_Yearly_ZonalStats_Barrios_${year}.geojson`,
        name: `SO2_Yearly_${year}.geojson`
    };
});

const so2TrendFiles_json_Barrio = [
    { url: '/assets/data/geojson/SO2/SO2_Yearly_ZonalStats/SO2_Yearly_ZonalStats_Barrios/Trend_SO2_ZonalStats_Barrios.geojson', name: 'SO2_Trend.geojson' },
    { url: '/assets/data/csv/SO2_Mensual_Comunal.csv', name: 'SO2_Monthly.csv' },
    { url: '/assets/data/csv/SO2_Anual_Comunal.csv', name: 'SO2_Anual.csv' }
];
...
const so2MonthlyFiles_json_Manzanas = Array.from({ length: 12 }, (_, i) => {
    const month = String(i + 1).padStart(2, '0');
    return {
        url: `/assets/data/geojson/SO2/SO2_Monthly_ZonalStats/SO2_Monthly_ZonalStats_Manzanas/SO2_Monthly_ZonalStats_Manzanas_${month}.geojson`,
        name: `SO2_Monthly_${month}.geojson`
    };
}
);
...
const so2YearlyFiles_json_Manzanas = Array.from({ length: endYear - startYear + 1 }, (_, i) => {
    const year = startYear + i;
    return {
        url: `/assets/data/geojson/SO2/SO2_Yearly_ZonalStats/SO2_Yearly_ZonalStats_Manzanas/SO2_Yearly_ZonalStats_Manzanas_${year}.geojson`,
        name: `SO2_Yearly_${year}.geojson`
    };
}
);
...
const so2TrendFiles_json_Manzanas = [
    { url: '/assets/data/geojson/SO2/SO2_Yearly_ZonalStats/SO2_Yearly_ZonalStats_Manzanas/Trend_SO2_ZonalStats_Manzanas.geojson', name: 'SO2_Trend.geojson' },
    { url: '/assets/data/csv/SO2_Mensual_Comunal.csv', name: 'SO2_Monthly.csv' },
    { url: '/assets/data/csv/SO2_Anual_Comunal.csv', name: 'SO2_Anual.csv' }
];
