...
export async function map_ndvi_2023(map) {
    // Leer el archivo NDVI 2023
    const response = await fetch('/assets/vec/raster/NDVI_pixel/NDVI_Yearly/NDVI_Yearly_2023.tif');
