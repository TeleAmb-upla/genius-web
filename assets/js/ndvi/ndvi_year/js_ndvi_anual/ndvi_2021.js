...
export async function map_ndvi_2021(map) {
    // Leer el archivo NDVI 2021
    const response = await fetch('/assets/vec/raster/NDVI_pixel/NDVI_Yearly/NDVI_Yearly_2021.tif');
