...
export async function updateMapLayerYear(map, sourceId, layerId, year) {
    const url = `/assets/vec/vectoriales/AOD_Yearly_ZonalStats/AOD_Yearly_ZonalStats_Manzanas/AOD_Yearly_ZonalStats_Manzanas_${year}.geojson`;
...
export async function updateMapLayerMonth(map, sourceId, layerId, month) {
    const url = `/assets/vec/vectoriales/AOD_Monthly_ZonalStats/AOD_Monthly_ZonalStats_Manzanas/AOD_Monthly_ZonalStats_Manzanas_${month}.geojson`;
