...
export async function g_m_so2 () {
    ...
    d3.select("#p39").selectAll("*").remove();

    // Append the svg object to the div with id "p39"
    var svg = d3.select("#p39")
        .append("svg")
