...
export async function g_m_no2 () {
    ...
    d3.select("#p30").selectAll("*").remove();

    // Append the svg object to the div with id "p30"
    var svg = d3.select("#p30")
        .append("svg")
