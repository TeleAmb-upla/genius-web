...
El núcleo lineal (join por años, Sen, varianza MK, p-valor) vive en ``mk_slope_trend``.
Aquí: agregación año-mes → anual, tendencias enmascaradas y el raster NDVI (lógica propia).
...
from . import mk_slope_trend
from . import yearmonth as ym_lib

_group_size_func_raster = mk_slope_trend._group_size_func_raster
_mk_sen_slope_p_from_band_only = mk_slope_trend._mk_sen_slope_p_from_band_only
