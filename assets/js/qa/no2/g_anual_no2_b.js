...
export async function g_a_no2_b() {
    ...
    d3.select("#p32").selectAll("*").remove();

    // Append the svg object to the div with id "p32"
    var svg = d3.select("#p32")
        .append("svg")
