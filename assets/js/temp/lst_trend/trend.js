...
export async function map_trend(map) {
    try {
        // Leer el archivo  
        const response = await fetch(resolveAssetUrl('assets/data/raster/LST/LST_Trend/LST_Yearly_Trend.tif'));
...
export function createSTLegendSVG() {
    ...
    return `
        <svg class="map-legend-svg" width="165" height="${totalHeight + 80}" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="5" y="40" font-size="10" font-family="Arial">${lstRangeLabel}</text>
