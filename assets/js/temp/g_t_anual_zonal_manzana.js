...
const LST_URBAN_LINE = 'steelblue';

export async function g_t_a_z_m(containerId = "p17") {
    ...
    d3.select("#p17").selectAll("*").remove();

    // Append the svg object to the div with id "p17"
    var svg = d3.select("#p17")
        .append("svg")
    ...
    geniusAppendAnnualSeriesLegend(svg, {
        innerHeight,
        lineColor: LST_URBAN_LINE,
        bandFillColor: LST_URBAN_LINE,
