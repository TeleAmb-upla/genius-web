...
/** Climatología LST: azul; el acento térmico solo en «año actual». */
...
export async function g_t_m_z_b(containerId = "p15") {
    ...
    d3.select("#p15").selectAll("*").remove();

    // Append the svg object to the div with id "p15"
    var svg = d3.select("#p15")
        .append("svg")
