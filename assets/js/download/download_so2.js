...
const so2TrendFiles_tif = [
    ...
    { url: resolveAssetUrl('assets/data/csv/SO2_Mensual_Comunal.csv'), name: 'SO2_Monthly.csv' },
    { url: resolveAssetUrl('assets/data/csv/SO2_Anual_Comunal.csv'), name: 'SO2_Anual.csv' }
 ];
