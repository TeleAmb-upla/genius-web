...
export async function g_m_aod_m () {
    ...
    d3.select("#p27").selectAll("*").remove();

    // Append the svg object to the div with id "p27"
    var svg = d3.select("#p27")
        .append("svg")
   ...
   .text("AOD");
    ...
    // Parse the Data
    const data = await d3.csv(resolveAssetUrl("assets/data/csv/AOD_Mensual_Urbano.csv"));
