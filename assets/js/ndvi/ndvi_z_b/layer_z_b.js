...
export async function updateMapLayerYear(map, sourceId, layerId, year) {
    const url = `/assets/vec/vectoriales/NDVI_Yearly_ZonalStats_Barrios/NDVI_Yearly_ZonalStats_Barrios_${year}.geojson`;
...
export async function updateMapLayerMonth(map, sourceId, layerId, month) {
    const url = `/assets/vec/vectoriales/NDVI_Monthly_ZonalStats_Barrios/NDVI_Monthly_ZonalStats_Barrios_${month}.geojson`;
