...
export async function g_m_no2_m () {
    ...
    d3.select("#p36").selectAll("*").remove();

    // Append the svg object to the div with id "p36"
    var svg = d3.select("#p36")
        .append("svg")
