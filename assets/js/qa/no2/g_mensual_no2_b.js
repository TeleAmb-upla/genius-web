...
export async function g_m_no2_b() {
    ...
    d3.select("#p33").selectAll("*").remove();

    // Append the svg object to the div with id "p33"
    var svg = d3.select("#p33")
        .append("svg")
