...
export async function map_ndvi_2018(map) {
    // Leer el archivo NDVI 2018
    const response = await fetch('/assets/vec/raster/NDVI_pixel/NDVI_Yearly/NDVI_Yearly_2018.tif');
