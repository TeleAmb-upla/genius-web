...
export async function g_a_no2_m() {
    ...
    d3.select("#p35").selectAll("*").remove();

    // Append the svg object to the div with id "p35"
    var svg = d3.select("#p35")
        .append("svg")
    ...
    // Parse the Data
    const data = await d3.csv("./assets/csv/NO2_Anual.csv");
