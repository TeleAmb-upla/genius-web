...
export async function g_a_aod_b() {
    const container = document.getElementById("p23");
    ...
    d3.select("#p23").selectAll("*").remove();

    // Append the svg object to the div with id "p23"
    var svg = d3.select("#p23")
        .append("svg")
