...
export async function g_a_so2() {
    ...
    d3.select("#p38").selectAll("*").remove();

    // Append the svg object to the div with id "p38"
    var svg = d3.select("#p38")
        .append("svg")
...
svg.append("text")
    ...
    // Parse the Data
    const data = await d3.csv("/assets/csv/SO2_Anual_Regional.csv");
