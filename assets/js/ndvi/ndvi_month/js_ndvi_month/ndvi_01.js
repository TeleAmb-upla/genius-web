...
export async function map_ndvi_01(map) {
    // Leer el archivo NDVI del mes
    const response = await fetch('/assets/vec/raster/NDVI_pixel/NDVI_Monthly/NDVI_Monthly_01.tif');
